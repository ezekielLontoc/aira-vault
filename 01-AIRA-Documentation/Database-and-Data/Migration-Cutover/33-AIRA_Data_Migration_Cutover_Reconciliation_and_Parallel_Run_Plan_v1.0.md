---
title: "33-AIRA Data Migration Cutover Reconciliation and Parallel Run Plan v1.0"
source_file: "01-AIRA-Documentation/Database-and-Data/Migration-Cutover/33-AIRA_Data_Migration_Cutover_Reconciliation_and_Parallel_Run_Plan_v1.0.docx"
source_format: "docx"
...
tags:
  ...
  - "Migration-Cutover"
aliases:
  - "33-AIRA_Data_Migration_Cutover_Reconciliation_and_Parallel_Run_Plan_v1.0"
creator: "python-docx"
...
| Core Migration Rule  
AIRA may accept migrated data only when the data is classified, mapped, validated, reconciled, accepted by business owners, and linked to retained evidence. Anything else remains a candidate record, not an authoritative AIRA record. |
...
AIRA migration and cutover activities are approved only when the migration inventory, mapping, rehearsal, cutover, reconciliation, parallel run, recovery path, evidence package, and business acceptance are complete. A migration may be fast only after it is controlled; never before. |
