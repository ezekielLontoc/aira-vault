---
title: "15-AIRA API and Integration Contract Standard v2.0"
source_file: "01-AIRA-Documentation/API-and-Integration/15-AIRA_API_and_Integration_Contract_Standard_v2.0.docx"
source_format: "docx"
...
OpenAPI · AsyncAPI · CloudEvents · Contract-First · SOLID/AVCI-Governed
...
| L1 | AIRA Engineering Blueprint v5.0 | Service boundaries, data ownership, workflow partition, AI safety, and integration patterns. |
...
│   ├── microfunction-config-service/  
│   └── admin-governance-service/  
├── asyncapi/  
│   ├── document-lifecycle.yaml  
│   ├── microfunction-runtime.yaml  
│   ├── audit-events.yaml  
│   └── ai-governed-actions.yaml  
├── schemas/  
│   ├── json-schema/  
│   └── avro/  
├── examples/  
...
└── governance/  
    ├── CODEOWNERS  
    ├── contract-register.yaml  
    ├── deprecation-register.yaml  
    └── contract-evidence-register.yaml |
...
| paths:  
  /api/document/v1/documents:  
    post:  
      operationId: createDocumentIntake  
      summary: Create a document intake request  
      security:  
        - oidc: [document:intake:create]  
      parameters:  
        - name: X-Request-Id  
          in: header  
          required: false  
      ...
      requestBody:  
        ...
        content:  
          multipart/form-data:  
            schema: { $ref: '#/components/schemas/CreateDocumentIntakeRequest' }  
      responses:  
...
| type: com.aira.document.document-intake.accepted.v1  
...
extensions:  
  ...
  schema_id: document-intake-accepted  
  schema_version: 1.0.0  
  evidence_ref: openkm://.../evidence/... |
...
| {  
  "type": "https://aira/errors/validation-failed",  
  "title": "Validation failed",  
  "status": 400,  
  "detail": "One or more request fields are invalid.",  
  "error_code": "AIRA-VAL-0001",  
  "trace_id": "<trace-id>",  
  "request_id": "<request-id>",  
  "classification": "INTERNAL",  
  "violations": [ { "field": "document_type", "reason": "Unsupported value" } ]  
} |
...
info:  
  title: <Service API>  
  version: 1.0.0  
  x-aira-owner: <bounded-context-owner>  
  x-aira-classification: INTERNAL  
  x-aira-contract-id: API-<CONTEXT>-<NAME>-V1  
servers:  
  - url: /api/<bounded-context>/v1  
security:  
  - oidc: [<scope>]  
components:  
  securitySchemes:  
    ...
    ProblemBadRequest:  
      ...
      content:  
        application/problem+json:  
          schema: { $ref: '#/components/schemas/AiraProblem' } |
...
info:  
  ...
  x-aira-classification: INTERNAL  
channels:  
  aira.document.lifecycle.v1:  
    address: aira.document.lifecycle.v1  
    messages:  
      DocumentIntakeAccepted:  
        $ref: '#/components/messages/DocumentIntakeAccepted'  
components:  
  messages:  
    DocumentIntakeAccepted:  
      contentType: application/cloudevents+avro  
      headers:  
        type: object  
        required: [trace_id, request_id, tenant_id, classification, schema_id, schema_version]  
      payload:  
        $ref: '#/components/schemas/DocumentIntakeAcceptedPayload' |
