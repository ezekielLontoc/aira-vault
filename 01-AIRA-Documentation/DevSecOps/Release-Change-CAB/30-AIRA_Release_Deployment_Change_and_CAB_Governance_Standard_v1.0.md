...
source_file: "01-AIRA-Documentation/DevSecOps/Release-Change-CAB/30-AIRA_Release_Deployment_Change_and_CAB_Governance_Standard_v1.0.docx"
source_format: "docx"
...
tags:
  ...
  - "Release-Change-CAB"
aliases:
  - "30-AIRA_Release_Deployment_Change_and_CAB_Governance_Standard_v1.0"
creator: "Solutions Architecture Office"
created: "2013-12-23T23:15:00Z"
modified: "2013-12-23T23:15:00Z"
description: "Generated as AIRA-DOC-030 v1.0"
---
...
| Core Release Rule  
AIRA releases are not approved because code exists. They are approved because intent, design, implementation, verification, deployment, rollback, evidence, and ownership are complete. |
...
| One-Directional Promotion Invariant  
AIRA promotion follows one governed direction: DEV -> INT -> UAT -> STG -> PROD -> DR validation. Workstations, AI agents, and administrators do not mutate production directly. |
...
| Traceability Rule  
Every production release must be traceable from Zammad change/release record to backlog item, ADR/TDL, PR/MR, CI evidence, release artifact, GitOps deployment, runtime validation, and closure decision. |
...
AIRA release governance is complete only when the release is traceable, approved, deployed through governed paths, validated after deployment, supported by operations, and improved through evidence. Speed is valuable only when it remains secure, reversible, observable, and AVCI-complete. |
