---
document_id: "AIRA-DOC-028"
title: "AIRA Enterprise Design Principles and SOLID Reference Library"
version: "v1.1"
status: "aligned"
source_file: "28-AIRA_Enterprise_Design_Principles_and_SOLID_Reference_Library_v1.1_Aligned.docx"
source_format: "docx"
...
# AIRA Enterprise Design Principles and SOLID Reference Library
...
| **Property** | **Value** |
| --- | --- |
| **Document ID** | **AIRA-DOC-028 / 01A Reference Companion** |
| **Document Title** | **AIRA Enterprise Design Principles and SOLID Reference Library** |
| **Version** | **v1.1 - Supplemental Alignment Update** |
| **Supersedes** | **28-AIRA_Enterprise_Design_Principles_and_SOLID_Reference_Library_v1.0_Regenerated_Improved_Format** |
...
| **Target Pack / Register Placement** | **Pack 01 / Principle Reference Library** |
...
Formalized Document 28 as the reference-library companion to canonical 01A, not a competing duplicate source.

Aligned references to current AIRA v4.1 project baseline, Pack 01 v1.2, and Technology Stack v9.1.

Added current enforcement notes for Java 25, Dograh, GitNexus, LiteLLM, NeMo Guardrails, Harness, SBAC, OPA, Flyway, and GitOps.

Retained developer-friendly reference guidance while clarifying that 01A remains the mandatory enforcement standard.
