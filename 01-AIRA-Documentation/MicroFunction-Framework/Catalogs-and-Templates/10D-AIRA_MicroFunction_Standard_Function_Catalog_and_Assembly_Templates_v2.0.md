---
title: "10D-AIRA MicroFunction Standard Function Catalog and Assembly Templates v2.0"
source_file: "01-AIRA-Documentation/MicroFunction-Framework/Catalogs-and-Templates/10D-AIRA_MicroFunction_Standard_Function_Catalog_and_Assembly_Templates_v2.0.docx"
source_format: "docx"
...
Version 2.0 | April 2026 | INTERNAL CONFIDENTIAL
...
| Document ID | 10D-AIRA-MF-CATALOG-002 |

| Document Title | AIRA MicroFunction Standard Function Catalog and Assembly Templates |

| Version | v2.0 - Enterprise Design Principles and SOLID Enforcement Edition |
...
| Companion Documents | 01 AVCI v3.0; 02 Engineering Blueprint v5.0; 03 Developer Guide v4.0; 08 Unit Testing v3.0; 10/10A/10B/10C MicroFunction v3/v2 documents; 11 DevSecOps Standard; 12 CLAUDE.md Rollout Pack v3.0 |
...
| L1 | 10-AIRA MicroFunction Framework v3.0 | Defines runtime model, execution envelope, MicroFunction responsibility boundaries, and improvement constraints. |

| L2 | This 10D Catalog v2.0 | Defines step categories, standard function catalog, assembly templates, publish validators, and catalog evidence. |
...
| Phase 1 | Approve catalog v2.0 and register as authoritative 10D standard. | ARB/CAB approval record |
