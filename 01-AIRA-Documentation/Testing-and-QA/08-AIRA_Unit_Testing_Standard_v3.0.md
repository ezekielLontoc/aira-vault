---
title: "08-AIRA Unit Testing Standard v3.0"
source_file: "01-AIRA-Documentation/Testing-and-QA/08-AIRA_Unit_Testing_Standard_v3.0.docx"
source_format: "docx"
...
| Mandatory Testing Rule<br>A change without trustworthy tests is not production-ready. In AIRA v3.0, tests must prove not only functional correctness, but also preservation or improvement of SOLID compliance, Clean Architecture boundaries, DDD bounded contexts, ports-and-adapters separation, security posture, observability, idempotency, determinism, reversibility, rollbackability, and AVCI evidence. |
...
| Supersedes | 08-AIRA_Unit_Testing_Standard_v2.0 |
...
1. Executive Summary and v3.0 Review Verdict
...
This document upgrades the AIRA Unit Testing Engineering Standard from v2.0 to v3.0. The revision incorporates the Enterprise Design Principles and SOLID Enforcement Layer as a mandatory testing control. The test suite is no longer limited to proving functional behaviour; it must also prove that each change preserves or improves architecture discipline, security posture, observability, deterministic execution, reversibility, and AVCI evidence.
...
| v3.0 Testing Verdict<br>This standard is a major revision. It should be adopted after approval as the working test baseline for all AIRA production-bound changes. It is aligned to 01A, 01 AVCI v3.0, 02 Engineering Blueprint v5.0, and 03 Developer Guide v4.0. |
...
| L1 | This Unit Testing Engineering Standard v3.0 | TDD, unit/component tests, architecture tests, test evidence, AI Maker-Checker, CI quality gates. |

| L2 | 01A Enterprise Design Principles and 01 AVCI v3.0 | Universal principle gates and AVCI artifact quality requirements. |

| L2 | Developer Guide v4.0 and Technology Stack | Coding patterns and approved test tooling/version selection. |
...
| // Example ArchUnit-style intent, final syntax subject to tooling baseline  
classes().that().resideInAPackage("..domain..")  
  .should().onlyDependOnClassesThat().resideInAnyPackage(  
      "..domain..", "java..", "jakarta.validation..")  
  
noClasses().that().resideInAPackage("..domain..")  
  .should().dependOnClassesThat().resideInAnyPackage(  
      "org.springframework..", "org.apache.kafka..", "redis.clients..", "software.amazon..") |
...
| ### Test and Architecture Evidence Summary  
- Ticket / ADR / TDL:  
...
- AI tool involvement: none \| ChatGPT \| Codex \| Claude Code \| other  
- Human checker:  
...
| Approve v3.0 testing standard | A | R | C | C | C | I |
...
| AVCI Property | v3.0 Compliance Statement |
