---
document_id: "AIRA-DOC-019C"
title: "AIRA Agile AI DevSecOps Greenfield Backlog Planning Prompt Standard"
version: "v1.1"
status: "aligned"
source_file: "19C-AIRA_Agile_AI_DevSecOps_Greenfield_Backlog_Planning_Prompt_Standard_v1.1_Aligned.docx"
source_format: "docx"
vault_folder: "90-Candidates/Planning-Prompts"
...
# AIRA Agile AI DevSecOps Greenfield Backlog Planning Prompt Standard
...
**v1.1 - Formalized Supplemental Alignment Update | INTERNAL CONFIDENTIAL**

| **Property** | **Value** |
| --- | --- |
| **Document ID** | **AIRA-DOC-019C** |
| **Document Title** | **AIRA Agile + AI DevSecOps Greenfield Backlog Planning Prompt Standard** |
| **Version** | **v1.1 - Formalized Supplemental Alignment Update** |
| **Supersedes** | **A. AI-Native Project AIRA - Agile + AI DevSecOps Greenfield Backlog Planning Prompt.docx** |
...
| **Target Pack / Register Placement** | **Supplemental / Sprint 0 and Backlog Planning** |
...
Promoted previously unmatched prompt document into formal AIRA-DOC-019C to avoid uncontrolled prompt drift.

Aligned backlog planning to AIRA v4.1, Java 25 backend baseline, Pack 03 readiness, Pack 04 MicroFunction runtime, and Pack 05 Flyway controls.

Improved GitHub issue templates with explicit AVCI, Enterprise Design Principle, security, testing, CI/CD, and evidence fields.

Clarified that Sprint 0 / Ready-to-Code gates must precede mergeable business feature development.
...
# AIRA v4.1 Agile + AI DevSecOps Greenfield Backlog Planning Prompt
...
We are starting the **AI-Native Project – AIRA v4.1** as a **Greenfield enterprise-grade platform initiative** using Agile methodology, GitHub, and AI-assisted DevSecOps.
...
This project follows the AIRA v4.1 governance model, including:
