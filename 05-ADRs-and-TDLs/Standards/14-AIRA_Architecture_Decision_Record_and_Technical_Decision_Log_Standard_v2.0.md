---
title: "14-AIRA Architecture Decision Record and Technical Decision Log Standard v2.0"
source_file: "05-ADRs-and-TDLs/Standards/14-AIRA_Architecture_Decision_Record_and_Technical_Decision_Log_Standard_v2.0.docx"
source_format: "docx"
...
tags:
  ...
  - "Standards"
aliases:
  - "14-AIRA_Architecture_Decision_Record_and_Technical_Decision_Log_Standard_v2.0"
creator: "python-docx"
...
| docs/  
  adr/  
    accepted/ADR-AIRA-2026-001-enterprise-design-principles.md  
    proposed/  
    superseded/  
  tdl/  
    TDL-AIRA-2026-001-microfunction-error-policy.md  
  waivers/  
    WAIVER-AIRA-2026-001-temporary-tool-exception.md  
  templates/  
    adr-template.md  
    tdl-template.md |
...
| ADR-AIRA-YYYY-NNN: <Decision Title>  
Status: Proposed \| Review \| Accepted \| Implemented \| Superseded \| Rejected  
Owner: <Named owner>  
Approver: <Architecture / Security / CAB approver>  
Classification: <Public/Internal/Confidential/Restricted>  
Context: <Problem, constraints, drivers>  
Decision: <Chosen option>  
Alternatives: <Option A/B/C and do-nothing where applicable>  
Consequences: <Positive, negative, operational, security, compliance>  
Enterprise Design Principles Impact: <20-principle assessment>  
Verification and Fitness Functions: <Tests, CI checks, policy checks>  
Rollback / Reversibility: <Rollback, forward-fix, compensation, retirement>  
Implementation Links: <Tickets, repos, MRs, docs>  
AVCI Summary: <Attributable, Verifiable, Classifiable, Improvable> |

| --- |

| TDL-AIRA-YYYY-NNN: <Technical Decision Summary>  
Linked ADR/Ticket: <Reference>  
Decision: <Chosen implementation detail>  
Scope: <Service/package/files/config affected>  
Impact: <Security, testability, observability, rollback, 01A principles>  
Verification: <Tests/checks/review evidence>  
Owner/Reviewer: <Maker/Checker>  
Status: <Proposed/Accepted/Implemented/Superseded/Rejected> |
