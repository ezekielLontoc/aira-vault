---
document_id: "AIRA-DOC-034"
title: "AIRA Internal Audit Compliance Evidence and Control Testing Playbook"
version: "v1.1"
status: "aligned"
source_file: "34-AIRA_Internal_Audit_Compliance_Evidence_and_Control_Testing_Playbook_v1.1_Aligned.docx"
source_format: "docx"
vault_folder: "10-Evidence-Packs/Audit-Compliance-Control-Testing"
...
# AIRA Internal Audit Compliance Evidence and Control Testing Playbook
...
_Audit Evidence | Control Testing | Compliance Mapping | Evidence Sampling | Continuous Assurance_

**v1.1 - Pack 03 v1.2 Alignment and Java 25 Audit Evidence Update**

| **Property** | **Value** |
| --- | --- |
| **Document ID** | **AIRA-DOC-034** |
| **Document Title** | **AIRA Internal Audit, Compliance Evidence, and Control Testing Playbook** |
| **Document Version** | **v1.1 - Pack 03 v1.2 Alignment and Java 25 Audit Evidence Update** |
| **Supersedes** | **34-AIRA_Internal_Audit_Compliance_Evidence_and_Control_Testing_Playbook_v1.0** |
...
| **Numbering Treatment** | **Audit and compliance baseline** |
...
**Document role. **Defines evidence requirements, control testing, audit sampling, compliance mapping, and continuous assurance for AIRA.
...
Added Java 25 build/runtime/toolchain proof as auditable evidence for backend services and developer environments.

Aligned audit expectations with CI/CD evidence packs, release governance, operations SLO/SLA, BC/DR, and knowledge-governance controls.

Clarified audit treatment for GitNexus indexes, Dograh voice transcripts, LiteLLM model routes, NeMo guardrails, and AI-generated evidence.

Reinforced source authority: derivative summaries and indexes are evidence aids, not source-of-truth replacements.

Updated AVCI evidence sampling to include ownership, verification, classification, and improvement proof across every artifact class.
...
Document 34 · Version 1.0 · April 2026 · INTERNAL CONFIDENTIAL
